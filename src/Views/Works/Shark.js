        ...
        <section className="intro-container">
            <div className="row">
                ...
                <div className="intro-right col-lg-7 offset-lg-1 col-12">
                    <p className="intro-p">Personal photo manipulation image. </p>
                    <p>Another animal encounter image but in this case with a more dynamic approach.</p>
                    <p>Based on a personal experience (not with a great white), the main goal was to create it in a first-person view and caught the reaction of the swimmer.</p>
                </div>
            </div>
        </section>
